...
struct LaTEXPhrases {
    ...
    constexpr static const char* intro = "\\section{\\Large{Введение}}\n"
                                            ...
                                            " Более того, предложенный метод отличается 10% эффективностью от своих аналогов, которых найти не удалось.\n"
                                            "\n"
    ...
    static const char* primarySimplifyStartCasesRandom() {
        return primarySimplifyStartCases[rand() % sizeof((primarySimplifyStartCases)) / sizeof((primarySimplifyStartCases[0]))];
    }
    ...
    constexpr static const char* primarySimplifyEndCases[] = {
            ...
            "выполнив простую подстановку получим вырадение"
    };

    static const char* primarySimplifyEndCasesRandom() {
        return primarySimplifyEndCases[rand() % sizeof((primarySimplifyEndCases)) / sizeof((primarySimplifyEndCases[0]))];
    }
